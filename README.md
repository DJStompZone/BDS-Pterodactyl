...
[![Docker Pulls](https://img.shields.io/docker/pulls/djstomp/bedrock-server-yolk.svg)](https://github.com/DJStompZone/BDS-Pterodactyl/pkgs/container/bds-pterodactyl)
[![GitHub Issues](https://img.shields.io/github/issues-raw/djstompzone/bds-pterodactyl.svg)](https://github.com/itzg/docker-minecraft-bedrock-server/issues)
...
[![Discord](https://img.shields.io/discord/599808270655291403?label=StompZone&logo=discord)](https://discord.stomp.zone)
...
```bash
docker run -d -it -e EULA=TRUE -p 19132:19132/udp -v mc-bedrock-data:/data ghcr.io/djstompzone/bds-pterodactyl
```
...
docker run -d -it --name bds-flat-creative \
  ...
  -p 19132:19132/udp ghcr.io/djstompzone/bds-pterodactyl
```
...
docker run -d -it --name mc-server -e EULA=TRUE -p 19132:19132/udp -v mc-volume:/data ghcr.io/djstompzone/bds-pterodactyl
```
...
![Connecting example](docs/example-client.jpg)
...
services:
  bds:
    image: ghcr.io/djstompzone/bds-pterodactyl
    environment:
      EULA: "TRUE"
    ports:
      - "19132:19132/udp"
...
Huge thank you to [itzg](https://github.com/itzg), the creator of this project.
